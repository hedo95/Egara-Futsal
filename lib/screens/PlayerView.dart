...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: PlayerView(getAllPlayersFromFile().firstWhere((item) => item.surname == "TASCONES CASELLAS")),
    );
  }
}
...
class _GamesState extends State<Games> {
  ...
  _generateData() {
    ...
    var eventsData = [
      new GoalandCards('Partidos', this.playedgames, Colors.purple[900]),
    ...
    var pieData = [
      ...
      new Task('Partidos no disputados', this.totalgames - this.playedgames, Colors.pink[200]),
    ];

    Color insideLabelNumberColor(Task task){
      if(task.colorvalue == Colors.purple[900]){
